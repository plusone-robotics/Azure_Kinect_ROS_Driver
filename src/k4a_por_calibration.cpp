                                   ...
                                   std::string& res_msg)
{
  ...
  for(int i = 0; i < MAX_ITERATIONS_; i++)
  {
    ...
    else
    {
      ...
      *exposure_time_float_ptr -= LEARNING_RATE_ * (blue_rmse + green_rmse + red_rmse + white_rmse) * dis(gen) * 1000;
      ...
      *white_balance_float_ptr -= LEARNING_RATE_ * (blue_rmse + green_rmse + red_rmse + white_rmse) * dis(gen);
